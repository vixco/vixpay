...
import 'TransactionInfoWriteValue.dart';


class TransactionInfoWrite with ToString {
  /*
...
"writeSet":[]
 ...
 - "isDelete":"false"
  ...
  String? key;
  String? blockNo;
  TransactionInfoWriteValue? value;
  String? isDelete;

  TransactionInfoWrite({this.nameSpace, this.key, this.blockNo,this.value,this.isDelete
  });

  TransactionInfoWrite.fromJson(Map json)
      : nameSpace = json['nameSpace']??"",
        key = json['key']??"",
        blockNo = json['blockNo']??"",
        value= ((json['value']??"").isNotEmpty)?TransactionInfoWriteValue.fromJson(jsonDecode(json['value'])):null
  ;

  @override
  Map stringContentMap() =>
      {'nameSpace:': nameSpace, 'key': key, 'blockNo': blockNo};
}
