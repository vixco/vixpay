...
import 'package:yollet/Util/fetch_more/default_bottom_loader.dart';
import 'package:yollet/Util/fetch_more/default_error_builder.dart';
import 'package:yollet/Util/fetch_more/default_refresh_loader.dart';
import 'package:yollet/Util/fetch_more/fetch_more.dart';
import 'package:yollet/Util/fetch_more/fetch_more_bloc.dart';
import 'package:yollet/Util/localization/localizations.dart';
// import 'package:pay/Util/fetch_more/default_bottom_loader.dart';
// import 'package:flutter_bloc/flutter_bloc.dart';
...
class FetchMoreBuilderState extends State<FetchMoreBuilder> {
  late FetchMoreBloc fetchMoreBloc;
          ...
          if (state.list == null) {
            return Center(
              child: Text(AppLocalizations.of(context)!
                  .getString("no_data_available_now")),
            );
          }
