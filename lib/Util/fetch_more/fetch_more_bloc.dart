...
import 'package:yollet/Util/fetch_more/fetch_more_builder.dart';
import 'package:yollet/Util/fetch_more/fetch_more_event.dart';
import 'package:yollet/Util/fetch_more/fetch_more_state.dart';
...
class FetchMoreBloc extends Bloc<FetchMoreEvent, FetchMoreState> {
  ...
  FetchMoreBloc({this.dataFetcher, this.limit}) : super(InitialFetchMoreState()){
    index = 0;
    add(Fetch());
  }
