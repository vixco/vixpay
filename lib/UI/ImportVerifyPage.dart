...
class ImportVerifyPage extends StatefulWidget {

  @override
  ImportVerifyPageState createState() => ImportVerifyPageState();
}

class ImportVerifyPageState extends State<ImportVerifyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    builder: (_, InitState state) =>Scaffold(
      body: DefaultBody(Body(state),appBarWidget: CustomAppBar(title: "import_vixco_address",)),
      bottomSheet: Footer(),
    )
    );
  }
                  ...
                  child:BottomButton(
                    ...
                    onPressed: verificationCode.isNotEmpty
                      ...
                      if (result=="00") {
                        ...
                        appStore.dispatch(
                          NavigateToAction(
                              to: AppRoutes.importMnemonicPhasePage,
                              replace: true),
                        );
                      }else if (result=="21") {
                        actionDialog(title: 'error',
