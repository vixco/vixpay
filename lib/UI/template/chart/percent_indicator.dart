...
class LinearPercentIndicator extends StatefulWidget {
  ...
  LinearPercentIndicator(
      ...
      this.percent = 0.0,
      this.lineHeight = ThemeSizeStyle.margin_underCategory,
      //@required this.width,
      this.backgroundColor = ThemeColors.ReplyBg,
      this.progressColor = ThemeColors.theme_500,
...
class LinearPainter extends CustomPainter {
  ...
  LinearPainter(
    ...
    _paintLine.shader =
        LinearGradient(colors: [progressColor!, progressColor!.withOpacity(0.3)]).createShader(
            Rect.fromCircle(
