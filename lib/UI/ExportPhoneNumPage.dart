...
class ExportPhoneNumPage extends StatefulWidget {
  @override
  ExportPhoneNumPageState createState() => ExportPhoneNumPageState();
}

class ExportPhoneNumPageState extends State<ExportPhoneNumPage> {
                      ...
                      ? () async {
                          YolletState state =
                              StoreProvider.of<AppState>(context)
                                  ...
                                  .yolletState;
                          String result = await appStore.dispatch(
                              VerifyVerificationAction(
                                  verificationCode: verificationCode));
                          if (result == "00") {
                            setState(() {
                              secondsRemaining = 0;
                            });
                            await appStore.dispatch(ExportEthereumKeyAction(
                                address: state.ethereumInfo.address));
                            appStore.dispatch(NavigateToAction(
                                to: AppRoutes.createAccountConfirmMnemonic,
                                replace: true));
